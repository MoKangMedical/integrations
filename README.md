...
integrations - Medical AI Project
...
1. **克隆仓库**
```bash
git clone https://github.com/MoKangMedical/integrations.git
cd integrations
```
...
1. **构建镜像**
```bash
docker build -t integrations .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name integrations integrations
```
...
- **项目主页**: https://github.com/MoKangMedical/integrations
- **问题反馈**: https://github.com/MoKangMedical/integrations/issues
